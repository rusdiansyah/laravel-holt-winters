...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Holt Winters Rice by Price') }}
                    <button class="btn btn-primary btn-sm float-end" id="btn-create">Select Rice Type</button>
                </div>
